...
public class RecommendSection extends StatelessSection {
    ...
    public RecommendSection(RecommendViewModel viewModel, RecommendResult result) {
        super(new SectionParameters.Builder(R.layout.layout_recommend_item)
                .headerResourceId(R.layout.layout_recommend_header)
                .footerResourceId(R.layout.layout_recommend_footer)
                .build());
