...
import com.sunny.mvvmbilibili.databinding.FragmentSearchMovieBinding;
...
/**
 * The type Search movie fragment.
 * Created by Zhou Zejin on 2017/10/16.
 */
public class SearchMovieFragment extends LazyLoadFragment implements SearchMovieMvvmView {

    private static final String ARGUMENTS_QUERY_STRING =
            "com.sunny.mvvmbilibili.ui.search.movie.SearchMovieFragment.ARGUMENTS_QUERY_STRING";

    @Inject SearchMovieViewModel mViewModel;
    @Inject MovieAdapter mAdapter;
    ...
    public static SearchMovieFragment newInstance(String queryStr) {
