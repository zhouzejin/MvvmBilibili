...
import com.sunny.mvvmbilibili.databinding.FragmentSearchUpperBinding;
...
/**
 * The type Search upper fragment.
 * Created by Zhou Zejin on 2017/10/16.
 */
public class SearchUpperFragment extends LazyLoadFragment implements SearchUpperMvvmView {

    private static final String ARGUMENTS_QUERY_STRING =
            "com.sunny.mvvmbilibili.ui.search.upper.SearchUpperFragment.ARGUMENTS_QUERY_STRING";

    @Inject SearchUpperViewModel mViewModel;
    @Inject UpperAdapter mAdapter;
    @Inject @ActivityContext Context mContext;

    private FragmentSearchUpperBinding mBinding;
    ...
    public static SearchUpperFragment newInstance(String queryStr) {
        SearchUpperFragment fragment = new SearchUpperFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_search_upper, container, false);
        initRecyclerView();
